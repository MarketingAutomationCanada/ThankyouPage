...
$(document).ready(function () {
        ...
        document.getElementById('home').addEventListener('mouseover', function () {
            ...
            document.getElementById("navLink5").style.color = "#fff";
            document.getElementById("navLink5").style.background = "none";
            document.getElementById("navLink6").style.color = "#fff";
            document.getElementById("navLink6").style.background = "none";
        })
        ...
        document.getElementById('navLink5').addEventListener('mouseover', function () {
            document.getElementById("home").style.color = "#fff";
            document.getElementById("home").style.background = "none";
            document.getElementById("navLink1").style.color = "#fff";
            document.getElementById("navLink1").style.background = "none";
            ...
            document.getElementById("navLink4").style.color = "#fff";
            document.getElementById("navLink4").style.background = "none";
            document.getElementById("navLink5").style.color = "red";
            document.getElementById("navLink5").style.background = "#fff";
            document.getElementById("navLink6").style.color = "#fff";
            document.getElementById("navLink6").style.background = "none";
        })

        document.getElementById('navLink6').addEventListener('mouseover', function () {
            document.getElementById("home").style.color = "#fff";
            document.getElementById("home").style.background = "none";
            document.getElementById("navLink1").style.color = "#fff";
            document.getElementById("navLink1").style.background = "none";
            ...
            document.getElementById("navLink5").style.color = "#fff";
            document.getElementById("navLink5").style.background = "none";
            document.getElementById("navLink6").style.color = "red";
            document.getElementById("navLink6").style.background = "#fff";
        })
        ...
        document.getElementById('navLink5').addEventListener('mouseout', function () {
            document.getElementById("home").style.color = "red";
            document.getElementById("home").style.background = "#fff";
            document.getElementById("navLink1").style.color = "#fff";
            document.getElementById("navLink1").style.background = "none";
        ...
        document.getElementById('navLink6').addEventListener('mouseout', function () {
            document.getElementById("home").style.color = "red";
            document.getElementById("home").style.background = "#fff";
            document.getElementById("navLink1").style.color = "#fff";
            document.getElementById("navLink1").style.background = "none";
